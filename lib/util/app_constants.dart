...
class AppConstants {
  ...
  static const String generateOtpUri = '/api/v1/auth/generate_otp';
  static const String loginRegister = '/api/v1/auth/login_register';
  ...
  static const String userOtp = '6ammart_user_otp';
