...
import 'package:novo_instamart/features/brands/domain/repositories/brands_repository.dart';
import 'package:novo_instamart/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:novo_instamart/features/brands/domain/services/brands_service.dart';
import 'package:novo_instamart/features/brands/domain/services/brands_service_interface.dart';
import 'package:novo_instamart/features/coupon/domain/repositories/coupon_repository.dart';
...
import 'package:novo_instamart/features/home/domain/repositories/home_repository.dart';
import 'package:novo_instamart/features/home/domain/repositories/home_repository_interface.dart';
import 'package:novo_instamart/features/home/domain/services/home_service.dart';
...
import 'package:novo_instamart/features/taxi_booking/controllers/car_selection_controller.dart';
...
import 'package:novo_instamart/features/banner/domain/repositories/banner_repository.dart';
import 'package:novo_instamart/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:novo_instamart/features/banner/domain/services/banner_service.dart';
import 'package:novo_instamart/features/banner/domain/services/banner_service_interface.dart';
import 'package:novo_instamart/features/cart/domain/repositories/cart_repository.dart';
import 'package:novo_instamart/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:novo_instamart/features/cart/domain/services/cart_service.dart';
...
import 'package:novo_instamart/features/category/domain/reposotories/category_repository.dart';
import 'package:novo_instamart/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:novo_instamart/features/category/domain/services/category_service.dart';
...
import 'package:novo_instamart/features/chat/domain/repositories/chat_repository.dart';
import 'package:novo_instamart/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:novo_instamart/features/chat/domain/services/chat_service.dart';
...
import 'package:novo_instamart/features/coupon/domain/services/coupon_service.dart';
...
import 'package:novo_instamart/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:novo_instamart/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:novo_instamart/features/favourite/domain/services/favourite_service.dart';
...
import 'package:novo_instamart/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:novo_instamart/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:novo_instamart/features/flash_sale/domain/services/flash_sale_service.dart';
import 'package:novo_instamart/features/flash_sale/domain/services/flash_sale_service_interface.dart';
import 'package:novo_instamart/features/html/controllers/html_controller.dart';
import 'package:novo_instamart/features/html/domain/repositories/html_repository.dart';
import 'package:novo_instamart/features/html/domain/repositories/html_repository_interface.dart';
import 'package:novo_instamart/features/html/domain/services/html_service.dart';
...
import 'package:novo_instamart/features/item/domain/repositories/campaign_repository.dart';
import 'package:novo_instamart/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:novo_instamart/features/item/domain/repositories/item_repository.dart';
import 'package:novo_instamart/features/item/domain/repositories/item_repository_interface.dart';
import 'package:novo_instamart/features/item/domain/services/campaign_service.dart';
import 'package:novo_instamart/features/item/domain/services/campaign_service_interface.dart';
import 'package:novo_instamart/features/item/domain/services/item_service.dart';
...
import 'package:novo_instamart/features/language/domain/repository/language_repository.dart';
import 'package:novo_instamart/features/language/domain/repository/language_repository_interface.dart';
import 'package:novo_instamart/features/language/domain/service/language_service.dart';
...
import 'package:novo_instamart/features/taxi_booking/repo/car_selection_repo.dart';
import 'package:novo_instamart/features/taxi_booking/repo/cart_repo.dart';
...
import 'package:novo_instamart/features/address/domain/repositories/address_repository.dart';
import 'package:novo_instamart/features/address/domain/repositories/address_repository_interface.dart';
import 'package:novo_instamart/features/address/domain/services/address_service.dart';
...
import 'package:novo_instamart/features/auth/domain/reposotories/auth_repository.dart';
import 'package:novo_instamart/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:novo_instamart/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:novo_instamart/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:novo_instamart/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:novo_instamart/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:novo_instamart/features/auth/domain/services/auth_service.dart';
import 'package:novo_instamart/features/auth/domain/services/auth_service_interface.dart';
import 'package:novo_instamart/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:novo_instamart/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:novo_instamart/features/auth/domain/services/store_registration_service.dart';
...
import 'package:novo_instamart/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:novo_instamart/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:novo_instamart/features/checkout/domain/services/checkout_service.dart';
import 'package:novo_instamart/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:novo_instamart/features/location/domain/repositories/location_repository.dart';
import 'package:novo_instamart/features/location/domain/repositories/location_repository_interface.dart';
import 'package:novo_instamart/features/location/domain/services/location_service.dart';
...
import 'package:novo_instamart/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:novo_instamart/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:novo_instamart/features/loyalty/domain/services/loyalty_service.dart';
import 'package:novo_instamart/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:novo_instamart/features/notification/controllers/notification_controller.dart';
import 'package:novo_instamart/features/notification/domain/repository/notification_repository.dart';
import 'package:novo_instamart/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:novo_instamart/features/notification/domain/service/notification_service.dart';
import 'package:novo_instamart/features/notification/domain/service/notification_service_interface.dart';
import 'package:novo_instamart/features/onboard/controllers/onboard_controller.dart';
import 'package:novo_instamart/features/onboard/domain/repository/onboard_repository.dart';
import 'package:novo_instamart/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:novo_instamart/features/onboard/domain/service/onboard_service.dart';
...
import 'package:novo_instamart/features/order/domain/repositories/order_repository.dart';
import 'package:novo_instamart/features/order/domain/repositories/order_repository_interface.dart';
import 'package:novo_instamart/features/order/domain/services/order_service.dart';
...
import 'package:novo_instamart/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:novo_instamart/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:novo_instamart/features/parcel/domain/services/parcel_service.dart';
import 'package:novo_instamart/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:novo_instamart/features/payment/controllers/payment_controller.dart';
import 'package:novo_instamart/features/payment/domain/repositories/payement_repository.dart';
import 'package:novo_instamart/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:novo_instamart/features/payment/domain/services/payment_service.dart';
...
import 'package:novo_instamart/features/profile/domain/repositories/profile_repository.dart';
import 'package:novo_instamart/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:novo_instamart/features/profile/domain/services/profile_service.dart';
...
import 'package:novo_instamart/features/review/domain/repositories/review_repository.dart';
import 'package:novo_instamart/features/review/domain/repositories/review_repository_interface.dart';
import 'package:novo_instamart/features/review/domain/services/review_service.dart';
...
import 'package:novo_instamart/features/search/domain/repositories/search_repository.dart';
import 'package:novo_instamart/features/search/domain/repositories/search_repository_interface.dart';
import 'package:novo_instamart/features/search/domain/services/search_service.dart';
...
import 'package:novo_instamart/features/splash/domain/repositories/splash_repository.dart';
import 'package:novo_instamart/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:novo_instamart/features/splash/domain/services/splash_service.dart';
...
import 'package:novo_instamart/features/store/domain/repositories/store_repository.dart';
import 'package:novo_instamart/features/store/domain/repositories/store_repository_interface.dart';
import 'package:novo_instamart/features/store/domain/services/store_service.dart';
import 'package:novo_instamart/features/store/domain/services/store_service_interface.dart';
import 'package:novo_instamart/features/verification/controllers/verification_controller.dart';
import 'package:novo_instamart/features/verification/domein/reposotories/verification_repository.dart';
import 'package:novo_instamart/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:novo_instamart/features/verification/domein/services/verification_service.dart';
import 'package:novo_instamart/features/verification/domein/services/verification_service_interface.dart';
import 'package:novo_instamart/features/wallet/controllers/wallet_controller.dart';
import 'package:novo_instamart/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:novo_instamart/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:novo_instamart/features/wallet/domain/services/wallet_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  DeliverymanRegistrationRepositoryInterface
      deliverymanRegistrationRepositoryInterface =
      DeliverymanRegistrationRepository(apiClient: Get.find());
