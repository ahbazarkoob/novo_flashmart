...
import 'package:novo_instamart/common/widgets/hover/text_hover.dart';
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(children: [
                                    ...
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text('send_us_mail'.tr, style: figTreeBold),
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    InkWell(
                                      onTap: () async {
                                  ...
                                  Column(children: [
                                    ...
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text('contact_us'.tr, style: figTreeBold),
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text(_config.phone ?? '',
                                        style: figTreeRegular.copyWith(
                                  ...
                                  Column(children: [
                                    ...
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text('find_us_here'.tr, style: figTreeBold),
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    SizedBox(
                                      width: 200,
