...
import 'package:novo_instamart/features/brands/widgets/brands_view_shimmer_widget.dart';
                      ...
                      return Container(
                        ...
                        child: InkWell(
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImage(
                              image:
                                  '${Get.find<SplashController>().configModel!.baseUrls!.brandImageUrl}/${brandsController.brandList![index].image}',
                              height: 60,
                              width: 60,
                            ),
                          ),
