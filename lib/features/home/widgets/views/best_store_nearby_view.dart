...
import 'package:novo_flashMart/common/widgets/card_design/store_card.dart';
import 'package:novo_flashMart/common/widgets/card_design/store_card_with_distance.dart';
                                                                      ...
                                                                      child: Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                              Column(children: [
                                                                                Text('start_from'.tr, style: figTreeRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                                                                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                                Text(PriceConverter.convertPrice(storeList[index].minimumOrder), style: figTreeBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                                              ]),
                                                                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                                                              Row(children: [
                                                                                Icon(Icons.star, size: 15, color: Theme.of(context).primaryColor),
                                                                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                                Text(storeList[index].avgRating!.toStringAsFixed(1), style: figTreeRegular),
                                                                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                                Text("(${storeList[index].ratingCount.toString()})", style: figTreeRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                                                              ]),
                                                                            ]),
                                                                          ]),
                                                                    ),
                                                                    ...
                                                                    child: Row(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              ...
                                                                              style: figTreeBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                          const SizedBox(
                                                                              width: Dimensions.paddingSizeExtraSmall),
                                                                          Text(
                                                                              'from_you'.tr,
                                                                              style: figTreeRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                        ]),
                                                                  ),
                                                                ),
                                                              ]),
