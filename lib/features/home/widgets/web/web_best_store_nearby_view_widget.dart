                                                                ...
                                                                child: Column(
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                          children: [
                                                                            Text('start_from'.tr,
                                                                                style: figTreeRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                                                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                            Text(PriceConverter.convertPrice(storeList[index].minimumOrder),
                                                                                style: figTreeBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                                          ]),
                                                                      Row(
                                                                          children: [
                                                                            Icon(Icons.star,
                                                                            ...
                                                                            Text("(${storeList[index].ratingCount.toString()})",
                                                                                style: figTreeRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                                                          ]),
                                                                      Container(
                                                                        ...
                                                                        child: Row(
                                                                            children: [
                                                                              ...
                                                                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                              Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'km'.tr}', style: figTreeBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                                                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                              Text('from_you'.tr, style: figTreeRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                                                            ]),
                                                                      ),
                                                                    ]),
                                                              ),
