            ...
            ResponsiveHelper.isDesktop(context)
                ...
                : SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      ...
                      //   style: figTreeMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.black),
                      // ),
                        ...
                        children: [
                          Row(children: [
                            ClipRRect(
                              ...
                              child: CustomImage(
                                image:
                                    '${Get.find<SplashController>().configModel!.baseUrls!.campaignImageUrl}/${campaignController.basicCampaign!.image}',
                                height: 40,
                                width: 50,
                                fit: BoxFit.cover,
                              ),
