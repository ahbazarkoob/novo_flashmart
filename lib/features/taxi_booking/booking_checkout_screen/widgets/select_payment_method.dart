...
import 'package:novo_flashMart/features/taxi_booking/booking_checkout_screen/widgets/taxi_payment_button.dart';
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            //           TextSpan(text: " ${'booking_fee'.tr}",style: figTreeRegular.copyWith(color: Theme.of(context).primaryColor)),
            //         ],
            //       ),
            //     ),
