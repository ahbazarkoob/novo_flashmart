              ...
              child: Row(
                children: [
                  CustomImage(
                    ...
                    height: 46,
                    image:
                        '${Get.find<SplashController>().configModel!.baseUrls!.vehicleImageUrl}/${widget.vehicle.carImages!.isNotEmpty ? widget.vehicle.carImages![0] : ''}',
                  ),
                      ...
                      Row(
                        children: [
                          CustomImage(
                            ...
                            height: 20,
                            image:
                                '${Get.find<SplashController>().configModel!.baseUrls!.vehicleBrandImageUrl}/${''}',
                          ),
