                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        height: 40,
                        image:
                            '${userType == UserType.admin.name ? baseUrl!.businessLogoUrl : userType == UserType.vendor.name ? baseUrl!.storeImageUrl : baseUrl!.deliveryManImageUrl}/${user != null ? user!.image : ''}',
                      ),
                    ),
