    ...
    return Stack(children: [
      ...
      Column(
        ...
        children: [
          ...
          // isDesktop ? Text('general_info'.tr, style: figTreeMedium) : const SizedBox(),
          isDesktop
          ...
          Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  order.scheduled == 1
                      ? Row(children: [
                          Text('${'scheduled_at'.tr}:', style: figTreeRegular),
                          const Expanded(child: SizedBox()),
                          Text(
                  ...
                  Get.find<SplashController>()
                      ...
                      ? Row(children: [
                          Text('${'delivery_verification_code'.tr}:',
                              style: figTreeRegular),
                          const Expanded(child: SizedBox()),
                          Text(order.otp!, style: figTreeMedium),
                        ])
                      : const SizedBox(),
                  Divider(
                      height: Dimensions.paddingSizeLarge,
                      color: Theme.of(context).disabledColor.withOpacity(0.30)),
                  Row(children: [
                    Text(order.orderType!.tr, style: figTreeMedium),
                    const Expanded(child: SizedBox()),
                    Container(
                      padding: const EdgeInsets.symmetric(
                      ...
                      ? Column(children: [
                          Divider(
                              ...
                              color: Theme.of(context)
                                  ...
                                  .withOpacity(0.30)),
                          Row(children: [
                            Text('${'cutlery'.tr}: ', style: figTreeRegular),
                            const Expanded(child: SizedBox()),
                            Text(
                  ...
                  ? Container(
                      ...
                      child: parcel
                          ...
                          : Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                  Text('item_info'.tr, style: figTreeMedium),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  ListView.builder(
                                    shrinkWrap: true,
          ...
          (Get.find<SplashController>()
              ...
              ? Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        !isDesktop
                            ? Text('prescription'.tr, style: figTreeRegular)
                            : const SizedBox(),
                        !isDesktop
                            ? const SizedBox(
                                height: Dimensions.paddingSizeSmall)
          ...
          (order.orderStatus == 'delivered' &&
              ...
              ? Container(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('order_proof'.tr, style: figTreeRegular),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                        GridView.builder(
                          gridDelegate:
                              SliverGridDelegateWithFixedCrossAxisCount(
          ...
          (order.deliveryMan != null && isDesktop)
              ...
              : const SizedBox(),
          (order.deliveryMan != null && isDesktop)
              ? Text('delivery_man_details'.tr, style: figTreeMedium)
              : const SizedBox(),
          (order.deliveryMan != null && isDesktop)
              ? const SizedBox(height: Dimensions.paddingSizeLarge)
              : const SizedBox(),
          ...
          (!parcel && isDesktop)
              ...
              : const SizedBox(),
          (!parcel && isDesktop)
              ? Text('delivery_details'.tr, style: figTreeMedium)
              : const SizedBox(),
          (!parcel && isDesktop)
              ? const SizedBox(height: Dimensions.paddingSizeLarge)
              : const SizedBox(),
          ...
          isDesktop
              ? Row(
                  ...
                  children: [
                    Text('payment_method'.tr, style: figTreeMedium),
                    order.paymentMethod == 'offline_payment'
                        ? Text(
                    ...
                    return Padding(
                      ...
                      child: Row(children: [
                        Text(
                            ...
                            style: figTreeRegular),
                        Text(data.userData.toString(), style: figTreeRegular),
                      ]),
                    );
                  },
                )
