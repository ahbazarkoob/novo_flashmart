...
import 'package:novo_instamart/common/widgets/custom_divider.dart';
...
import 'package:novo_instamart/features/order/widgets/address_details_widget.dart';
...
class TrackDetailsViewWidget extends StatelessWidget {
  ...
  const TrackDetailsViewWidget(
      {super.key, required this.track, required this.status, this.callback});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!takeAway && track.deliveryMan == null)
          ...
          : Column(children: [
              Text('trip_route'.tr, style: figTreeMedium),
