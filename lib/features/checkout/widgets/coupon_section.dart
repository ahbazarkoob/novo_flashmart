...
import 'package:novo_instamart/features/checkout/widgets/coupon_bottom_sheet.dart';
              ...
              return Container(
                ...
                child: Column(children: [
                  Row(
                      ...
                      children: [
                        Text('promo_code'.tr, style: figTreeMedium),
                        InkWell(
                          onTap: () {
                                  ...
                                  if (checkoutController
                                    ...
                                    if (Get.find<CouponController>().discount! <
                                        ...
                                        !Get.find<CouponController>()
                                            .freeDelivery) {
                                      if (checkoutController.couponController
                                              .text.isNotEmpty &&
                                          !Get.find<CouponController>()
                                              .isLoading) {
                                        Get.find<CouponController>()
