          ...
          children: [
            ...
            (couponController.discount! > 0 || couponController.freeDelivery)
                ? Column(children: [
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('coupon_discount'.tr, style: figTreeRegular),
            ...
            referralDiscount > 0
                ? Column(children: [
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('referral_discount'.tr, style: figTreeRegular),
                          Text(
            ...
            (!takeAway &&
                ...
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('delivery_man_tips'.tr, style: figTreeRegular),
                      Text(
            ...
            (checkoutController.store!.extraPackagingStatus! &&
                ...
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('extra_packaging'.tr, style: figTreeRegular),
                      Text(
            ...
            //         mainAxisAlignment: MainAxisAlignment.spaceBetween,
            //         children: [
            //             Text('delivery_fee'.tr, style: figTreeRegular),
            //             checkoutController.distance == -1
            //                 ? Text(
            //                     'calculating'.tr,
            //                     style:
            //                         figTreeRegular.copyWith(color: Colors.red),
            //                   )
            //                 : (deliveryCharge == 0 ||
            //                         (couponController.coupon != null &&
            //                             couponController.coupon!.couponType ==
            ...
            checkoutController.isPartialPay
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                        Text('paid_by_wallet'.tr, style: figTreeRegular),
                        Text(
