...
import 'package:novo_flashMart/features/checkout/widgets/time_slot_bottom_sheet.dart';
      ...
      storeId == null &&
          ...
          ? Container(
              ...
              child: Column(
                  ...
                  children: [
                    Row(children: [
                      Text('preference_time'.tr, style: figTreeMedium),
                      ...
                      JustTheTooltip(
                        ...
                        content: Padding(
                          ...
                          child: Text('schedule_time_tool_tip'.tr,
                              style:
                                  figTreeRegular.copyWith(color: Colors.white)),
                        ),
                        child: InkWell(
