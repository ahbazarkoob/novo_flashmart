...
import 'package:novo_instamart/features/checkout/widgets/slot_widget.dart';
                        ...
                        : checkoutController.timeSlots != null
                            ? checkoutController.timeSlots!.isNotEmpty
                                ? GridView.builder(
                                    ...
                                    itemCount:
                                        checkoutController.timeSlots!.length,
    ...
    return InkWell(
      ...
      child: Column(
        children: [
          Text(title,
              style: isSelected
                  ? figTreeBold.copyWith(color: Theme.of(context).primaryColor)
                  : figTreeMedium),
          ResponsiveHelper.isDesktop(context)
