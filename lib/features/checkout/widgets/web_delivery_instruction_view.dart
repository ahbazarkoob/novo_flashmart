        ...
        child: GetBuilder<CheckoutController>(builder: (checkoutController) {
          return Column(
              ...
              children: [
                ...
                //   title: Text('add_more_delivery_instruction'.tr, style: figTreeMedium),
                ...
                //                   style: figTreeMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor),
                //                 ),
                //               ),
                //             ]),
                //           ),
                ...
                //         style: figTreeRegular.copyWith(color: Theme.of(context).primaryColor),
                //       ),
                //
                //       InkWell(
